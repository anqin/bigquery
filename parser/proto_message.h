...
#ifndef  BIGQUERY_UTILS_PROTO_MESSAGE_H
#define  BIGQUERY_UTILS_PROTO_MESSAGE_H
...
private:
    scoped_ptr<DiskSourceTree>          m_source_tree;
    scoped_ptr<Importer>                m_importer;
    scoped_ptr<Database>                m_data_base;
    scoped_ptr<DescriptorPool>          m_des_pool;
    scoped_ptr<DynamicMessageFactory>   m_factory;
...
#endif  // BIGQUERY_UTILS_PROTO_MESSAGE_H
