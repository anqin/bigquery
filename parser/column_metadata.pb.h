...
class ColumnStaticInfo : public ::google::protobuf::Message {
 public:
  ...
  // required .bigquery.io.ColumnType column_type = 3;
  inline bool has_column_type() const;
  inline void clear_column_type();
  static const int kColumnTypeFieldNumber = 3;
  inline bigquery::io::ColumnType column_type() const;
  inline void set_column_type(bigquery::io::ColumnType value);
  ...
  // @@protoc_insertion_point(class_scope:bigquery.io.ColumnStaticInfo)
 private:
...
class ColumnDynamicInfo : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:bigquery.io.ColumnDynamicInfo)
 private:
...
class ColumnMetaData : public ::google::protobuf::Message {
 public:
  ...
  // required .bigquery.io.ColumnStaticInfo static_info = 1;
  inline bool has_static_info() const;
  inline void clear_static_info();
  static const int kStaticInfoFieldNumber = 1;
  inline const ::bigquery::io::ColumnStaticInfo& static_info() const;
  inline ::bigquery::io::ColumnStaticInfo* mutable_static_info();
  inline ::bigquery::io::ColumnStaticInfo* release_static_info();
  
  // required .bigquery.io.ColumnDynamicInfo dynamic_info = 2;
  inline bool has_dynamic_info() const;
  inline void clear_dynamic_info();
  static const int kDynamicInfoFieldNumber = 2;
  inline const ::bigquery::io::ColumnDynamicInfo& dynamic_info() const;
  inline ::bigquery::io::ColumnDynamicInfo* mutable_dynamic_info();
  inline ::bigquery::io::ColumnDynamicInfo* release_dynamic_info();
  
  // @@protoc_insertion_point(class_scope:bigquery.io.ColumnMetaData)
 private:
  ...
  ::bigquery::io::ColumnStaticInfo* static_info_;
  ::bigquery::io::ColumnDynamicInfo* dynamic_info_;
...
inline bigquery::io::ColumnType ColumnStaticInfo::column_type() const {
  return static_cast< bigquery::io::ColumnType >(column_type_);
}
inline void ColumnStaticInfo::set_column_type(bigquery::io::ColumnType value) {
  GOOGLE_DCHECK(bigquery::io::ColumnType_IsValid(value));
  set_has_column_type();
  column_type_ = value;
}
...
inline void ColumnMetaData::clear_static_info() {
  if (static_info_ != NULL) static_info_->::bigquery::io::ColumnStaticInfo::Clear();
  clear_has_static_info();
}
inline const ::bigquery::io::ColumnStaticInfo& ColumnMetaData::static_info() const {
  return static_info_ != NULL ? *static_info_ : *default_instance_->static_info_;
}
inline ::bigquery::io::ColumnStaticInfo* ColumnMetaData::mutable_static_info() {
  set_has_static_info();
  if (static_info_ == NULL) static_info_ = new ::bigquery::io::ColumnStaticInfo;
  return static_info_;
}
inline ::bigquery::io::ColumnStaticInfo* ColumnMetaData::release_static_info() {
  clear_has_static_info();
  ::bigquery::io::ColumnStaticInfo* temp = static_info_;
  static_info_ = NULL;
  return temp;
}
...
inline void ColumnMetaData::clear_dynamic_info() {
  if (dynamic_info_ != NULL) dynamic_info_->::bigquery::io::ColumnDynamicInfo::Clear();
  clear_has_dynamic_info();
}
inline const ::bigquery::io::ColumnDynamicInfo& ColumnMetaData::dynamic_info() const {
  return dynamic_info_ != NULL ? *dynamic_info_ : *default_instance_->dynamic_info_;
}
inline ::bigquery::io::ColumnDynamicInfo* ColumnMetaData::mutable_dynamic_info() {
  set_has_dynamic_info();
  if (dynamic_info_ == NULL) dynamic_info_ = new ::bigquery::io::ColumnDynamicInfo;
  return dynamic_info_;
}
inline ::bigquery::io::ColumnDynamicInfo* ColumnMetaData::release_dynamic_info() {
  clear_has_dynamic_info();
  ::bigquery::io::ColumnDynamicInfo* temp = dynamic_info_;
  dynamic_info_ = NULL;
  return temp;
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< bigquery::io::ColumnType>() {
  return bigquery::io::ColumnType_descriptor();
}
