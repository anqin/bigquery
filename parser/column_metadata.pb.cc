...
void protobuf_AddDesc_column_5fmetadata_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "aData\0222\n\013static_info\030\001 \002(\0132\035.bigquery.io"
    ".ColumnStaticInfo\0224\n\014dynamic_info\030\002 \002(\0132"
    "\036.bigquery.io.ColumnDynamicInfo*\237\002\n\nColu"
        ...
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
         ...
         parse_column_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (bigquery::io::ColumnType_IsValid(value)) {
            set_column_type(static_cast< bigquery::io::ColumnType >(value));
          } else {
...
void ColumnMetaData::InitAsDefaultInstance() {
  static_info_ = const_cast< ::bigquery::io::ColumnStaticInfo*>(&::bigquery::io::ColumnStaticInfo::default_instance());
  dynamic_info_ = const_cast< ::bigquery::io::ColumnDynamicInfo*>(&::bigquery::io::ColumnDynamicInfo::default_instance());
}
...
void ColumnMetaData::MergeFrom(const ColumnMetaData& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_static_info()) {
      mutable_static_info()->::bigquery::io::ColumnStaticInfo::MergeFrom(from.static_info());
    }
    if (from.has_dynamic_info()) {
      mutable_dynamic_info()->::bigquery::io::ColumnDynamicInfo::MergeFrom(from.dynamic_info());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
